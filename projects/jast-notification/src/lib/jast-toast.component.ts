...
@Component({
  ...
  styles: [
    `
      ...
      .tab-left:not(.bottom) .jast-body {
        border-top-left-radius: 0 !important;
      }
      .tab-left.bottom .jast-body {
        border-bottom-left-radius: 0 !important;
      }
      .tab-left .jast-tab::before {
      ...
      .tab-right:not(.bottom) .jast-body {
        border-top-right-radius: 0 !important;
      }
      .tab-right.bottom .jast-body {
        border-bottom-right-radius: 0 !important;
      }
      .tab-right .jast-tab::after {
        display: none !important;
      }
      ...
      .jast-toast:not(.bottom) .jast-tab::before {
        ...
        background: radial-gradient(
          circle at 0 0,
          transparent var(--curve-size),
          var(--toast-bg) calc(var(--curve-size) + 0.5px)
        );
      }
      ...
      .exiting:not(.bottom) .jast-tab {
        animation: tab-exit-top 0.3s cubic-bezier(0.55, 0, 1, 0.45) forwards;
      }
      .exiting.bottom .jast-tab {
        animation: tab-exit-bottom 0.3s cubic-bezier(0.55, 0, 1, 0.45) forwards;
      }
      ...
      .success .jast-progress-bar {
        background: #10b981;
      }
      .error .jast-progress-bar {
        background: #ef4444;
      }
      .warning .jast-progress-bar {
        background: #f59e0b;
      }
      .info .jast-progress-bar {
        background: #3b82f6;
      }

      .paused .jast-progress-bar {
...
export class JastToastComponent implements OnInit, OnDestroy {
  ...
  get toastClass(): string {
    ...
    const hasBody =
      this.config?.description || this.config?.actions?.length || this.config?.progress
        ? ' has-body'
        : '';
