...
@Component({
      ...
      <div class="inner">
        <div class="cols">
          <div class="left">
            ...
            <p class="hero-desc">
              La biblioteca de notificaciones reactiva definitiva para Angular. API nativa basada en
              Promises, cero dependencias externas y control total sobre el flujo de tu UI.
            </p>
                ...
                <div class="deco-body">
                  <div class="deco-body-inner">
                    <div class="deco-body-content">
                      <p class="deco-desc">
                        Los cambios se aplicaron en tu servidor correctamente.
                      </p>
              ...
              <div class="deco-toast warning float-2">
                ...
                <div class="deco-body">
                  <div class="deco-body-inner">
                    <div class="deco-body-content">
                      <p class="deco-desc">
                        Esta acción eliminará la base de datos permanentemente.
                      </p>
  ...
  styles: [
    `
      ...
      .deco-toast.success {
        --accent-color: #10b981;
        --icon-grad: linear-gradient(135deg, #10b981, #059669);
      }
      .deco-toast.warning {
        --accent-color: #f59e0b;
        --icon-grad: linear-gradient(135deg, #f59e0b, #d97706);
      }
      .deco-toast.info {
        --accent-color: #3b82f6;
        --icon-grad: linear-gradient(135deg, #3b82f6, #6366f1);
      }
      ...
      .deco-toast:not(.compact) .deco-tab::before {
        ...
        background: radial-gradient(
          circle at 0 0,
          transparent var(--curve),
          var(--bg) calc(var(--curve) + 0.5px)
        );
      }
      .deco-toast:not(.compact) .deco-tab::after {
        bottom: 15px;
