      ...
      <div class="inner">
        ...
        <div class="doc-block">
          <div class="doc-header">
            <h3>Básicos</h3>
            <p>
              Inyectá <code>JastNotificationService</code> en cualquier componente
              y usá los métodos disponibles. No requiere configuración adicional —
              el servicio está disponible globalmente con <code>providedIn: 'root'</code>.
            </p>
          </div>
        ...
        <div class="doc-block api">
          <div class="doc-header">
            <h3>API Reference</h3>
            <p>
              Todos los métodos aceptan un objeto <code>JastToastConfig</code>.
              Solo <code>title</code> es requerido, el resto es opcional.
            </p>
          </div>
          <div class="api-table">
        ...
        <div class="doc-block">
          <div class="doc-header">
            ...
            <p>
              Los toasts exponen CSS custom properties que podés sobreescribir
              desde tus estilos globales. Aplicalas sobre la clase <code>.jast-toast</code>
...
export class DocsComponent {
  apiProps = [
    ...
    { name: 'type',        type: 'JastToastType?',     desc: "'success' | 'error' | 'warning' | 'info'. Default: 'info'." },
    { name: 'duration',    type: 'number?',            desc: 'Tiempo visible en milisegundos. Default: 3000.' },
    { name: 'position',    type: 'JastToastPosition?', desc: "Posición en pantalla. Default: 'top-right'." },
  ];
